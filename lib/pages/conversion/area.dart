...
class _AreaState extends State<Area> {
  ...
  final List<String> _units = ["m²", "cm²", "mm²", "km²", "acre", "hectare"];

  final Map<String, double> _conversionToSqMeter = {
    "m²": 1.0,
    "cm²": 0.0001,
    "mm²": 0.000001,
    "km²": 1000000.0,
  ...
  String _convert(String value, String from, String to) {
    ...
    double inSqMeters = val * (_conversionToSqMeter[from] ?? 1);
    double result = inSqMeters / (_conversionToSqMeter[to] ?? 1);
  ...
  String _getLabel(String unit) {
    switch (unit) {
      case "m²": return "Square Meter";
      case "cm²": return "Square Centimeter";
      case "mm²": return "Square Millimeter";
      case "km²": return "Square Kilometer";
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: Center(
              child: Text("Area Converter", style: TextStyle(color: Colors.purpleAccent, fontSize: 22)),
            ),
          ),
